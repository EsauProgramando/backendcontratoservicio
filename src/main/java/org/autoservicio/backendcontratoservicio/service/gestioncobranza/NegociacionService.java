...
public class NegociacionService {
    ...
    public Mono<List<ClienteContratoxServicio>> clientesContratoxServicioContratados(Integer id_cliente) {
        return Mono.fromCallable(() -> this.repo.clientesContratoxServicioContratados(id_cliente));
    }

    public Mono<responseModel> modificarEstadoNegociacion(NegociacionModel obj) {
        return Mono.fromCallable(() -> this.repo.modificarEstadoNegociacion(obj));
    }
